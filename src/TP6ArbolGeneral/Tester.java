...
public class Tester<E> {
	...
	public static void main(String s[]) {
		...
		Ejercicios<Integer> ei = new Ejercicios<>();
		try {
		//ej 2 y 6
		...
		System.out.println();System.out.println("----PREORDEN----");
		ei.preOrdenShell(t2);
		System.out.println();System.out.println("---------------------");
		System.out.println();System.out.println("----POSTORDEN----");
		ei.postOrdenShell(t2);
		System.out.println();System.out.println("---------------------");
		System.out.println();System.out.println("----INORDEN----");
		ei.inOrdenShell(t2);
		System.out.println();System.out.println("---------------------");
