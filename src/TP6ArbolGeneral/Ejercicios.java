...
public class Ejercicios<E> {
	...
	//preOrden
	public void preOrdenShell(Tree<E> t) {
		try {
			preOrden(t,t.root());
		}catch(EmptyTreeException e) {}
	}
	private void preOrden(Tree<E> t, Position<E> n) {
		try {
	...
	//postOrden
	public void postOrdenShell(Tree<E> t) {
		try {
			postOrden(t,t.root());
		}catch(EmptyTreeException e) {}
	}
	private void postOrden(Tree<E> t, Position<E> n) {
		try {
			for(Position<E> h : t.children(n)) {
				postOrden(t,h);
			}
	...
	//inOrden
	public void inOrdenShell(Tree<E> t) {
		try {
			inOrden(t,t.root());
		}catch(EmptyTreeException e) {}
	}
	private void inOrden(Tree<E> t, Position<E> n) {
		try {
			for(Position<E> h : t.children(n)) {
				inOrden(t,h);
			}
